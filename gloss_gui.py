...
menubar.add_command(label="Open", command=MyClass.OpenFile)
menubar.add_command(label="Plot", command=MyClass.readnplot)
menubar.add_command(label="Close", command=gloss.destroy)


gloss.config(menu=menubar)
gloss.mainloop()
